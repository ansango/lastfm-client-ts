...
type UserGetPersonalTagsRequest = {};
type UserGetPersonalTagsResponse = {};

type UserGetRecentTracksRequest = {};
type UserGetRecentTracksResponse = {};

type UserGetTopAlbumsRequest = {};
type UserGetTopAlbumsResponse = {};

type UserGetTopArtistsRequest = {};
type UserGetTopArtistsResponse = {};

type UserGetTopTagsRequest = {};
type UserGetTopTagsResponse = {};

type UserGetTopTracksRequest = {};
type UserGetTopTracksResponse = {};

type UserGetWeeklyAlbumChartRequest = {};
type UserGetWeeklyAlbumChartResponse = {};

type UserGetWeeklyArtistChartRequest = {};
type UserGetWeeklyArtistChartResponse = {};

type UserGetWeeklyChartListRequest = {};
