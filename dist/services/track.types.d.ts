import type { AlbumName, ArtistName, Content, Count, Duration, For, Image, ItemsPerPage, Limit, Listeners, Match, Mbid, Page, Playcount, Position, Published, Role, SearchTerms, StartIndex, StartPage, Summary, TagName, TotalResults, TrackName, Url, UserName } from './base.types';
