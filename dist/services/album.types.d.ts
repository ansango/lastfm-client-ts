import type { AlbumName, ArtistName, Lang, Mbid, UserName, TagName, Url, Count, Limit, Page, Text, TotalResults, StartIndex, ItemsPerPage, For, Image, Duration, Name, Published, Summary, Content, Playcount, Listeners, Role, SearchTerms, StartPage } from './base.types';
type AlbumTag = {
    tag?: Array<{
        name: TagName;
        url: Url;
