import type { AlbumName, ArtistName, Content, Count, Duration, From, Image, ItemsPerPage, Lang, Limit, Mbid, Page, Rank, Reach, Summary, TagName, To, Total, TotalPages, TrackName, Url } from './base.types';
export type TagWiki = {
    summary: Summary;
    content: Content;
};
