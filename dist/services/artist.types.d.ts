import type { ArtistName, Content, Count, For, Image, ItemsPerPage, Lang, Limit, Listeners, Match, Mbid, Page, Playcount, Published, Rank, Role, SearchTerms, StartIndex, StartPage, Summary, TagName, Text, Total, TotalPages, TotalResults, Url, UserName } from './base.types';
